              ...
              child: SizedBox(
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    return Column(
                      children: [
                        CircleAvatar(radius: width * height * 0.000131, child: const Icon(Icons.supervised_user_circle),),
                        SizedBox(height: height * 0.00985,),
                        Text("Name Here", style: TextStyle(fontSize: width * height * 0.0000492,),),
                        SizedBox(height: height * 0.00369,),
                        InkWell(
                          onTap: () {

                          },
                          child: Text("Follow", style: TextStyle(fontSize: width * height * 0.0000426, fontWeight: FontWeight.w600, color: const Color(0xFF007AFF),),),
                        ),
                      ],
                    );
                  },
